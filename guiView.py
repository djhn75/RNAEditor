...
#
# Created: Tue Oct 22 12:42:28 2013
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        QtCore.QObject.connect(self.actionNew_Assay, QtCore.SIGNAL(_fromUtf8("triggered()")), self.control.newAssay)
        QtCore.QObject.connect(self.pushButton_start, QtCore.SIGNAL(_fromUtf8("clicked()")), self.control.newAssay)
